...
const Navbar = () => {
  return (
  <nav className="w-full bg-white flex items-center justify-between px-8 py-2 font-[Kantumruy_Pro] font-semibold text-[16px]">
      <div className="flex items-center">
            <img src="/logo3.png" alt="Food Mech Logo" className="h-12 w-auto mr-4" />
        
      </div>
      <div className="flex items-center space-x-6">
        <a href="#" className="font-bold text-sm hover:text-pink-600">Home</a>
