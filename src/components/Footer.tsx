      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start px-16 pb-28">
        ...
        <div className="flex-1 min-w-[200px] mb-8 md:mb-0 px-12">
          ...
          <ul className="space-y-4 text-black text-base">
            ...
            <li><a href="#" className="hover:underline">Book Stall</a></li>
        ...
        <div className="flex-1 min-w-[300px] pl-12">
          ...
          <div className="flex items-start gap-3 mb-4">
            <img src="/images/location.png" alt="Location" className="w-6 h-6 mt-1" />
            <span className="text-black text-base leading-relaxed">
              UG-17, Ascon Plaza, Behind Bhulka Bhavan School, Anand Mahal road, Adajan, Surat, Gujarat</span>.
          </div>
          <div className="flex items-center gap-2 mb-2">
            <img src="/images/img_frame.svg" alt="Email" className="w-5 h-5" />
            <span className="text-black text-base">marketing.foodmechasia@gmail.com</span>
          </div>
